...
function checkForm(form){
    ...
    <body>
        <form action="AddUser.action" onsubmit="return checkForm(this);" id="addForm">
            <div
                style="FILTER: dropshadow(color = #B4BBCF, offx = 6, offy = 6, positive = 1);margin-top: 100px;"
                align="center">
                <font face="黑体" color="#CB4F30" size="3"><b>新用户注册</font>
            </div>
            
            <div style="margin-top: 20px;">
                <table cellpadding="3" cellspacing="1" align="center" border="1" class="tableborder1" id="table1">
                    <tr>
                    ...
                    <tr>
                        ...
                        <td width="60%" class="tablebody1">
                            <input type="text" maxLength="8" size="32" id="loginName" name="user.loginName" />
                    ...
                    <tr>
                        ...
                        <td width="60%" class="tablebody1">
                            <input type="text" maxLength="8" size="32" id="userName" name="user.userName" />
                            <font color="#FF0000">*</font>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td width="100%" valign="middle" colspan="2" align="center" height="25">
                           <div>
                             <input type="submit" value="注 册"  onclick="" class="bruce-button"/>
                             <input type="reset" name="reset" value="清 除"  class="bruce-button"/>
                           </div>
                        </td>
                    </tr>
                </table>
