...
%>
	...
	<s:form id="fileUploadForm" name="fileUploadForm" action="upload.action" theme="simple" method="post" enctype="multipart/form-data">
    <input type="hidden" id="p" name="p" value="<%=p %>">
    <table align="center" width="40%" border="1">
    <tr  class="formword"><td colspan="2">
    <font color="#FF00FF">
    	注意： 请选取图片上传，允许类型为GIF、JPG、JPEG、PNG ，档案大小不可超过 500 KB 。 
    </font>
    </td></tr>
    <tr>
    <td>图片</td>
